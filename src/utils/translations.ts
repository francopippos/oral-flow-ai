...
export const italianTranslations: TranslationKeys = {
  ...
  'hero.subtitle': 'La nostra AI studia ed unisce in una unica soluzione gli appunti del professore e i libri. Carica i tuoi PDF, l\'AI li studia e semplifica, poi spiega a voce e ricevi feedback mirato per performance da 30 e lode.',
  ...
  'hero.requestAccess': 'Inizia Gratis',
  ...
  'hero.stat1': 'Tempo di Studio Ridotto',
  'hero.stat2': 'Velocità Apprendimento',
  'hero.stat3': 'Esami Superati',
...
export const englishTranslations: TranslationKeys = {
  ...
  'hero.title': 'The AI that reduces study time by 70%',
  'hero.subtitle': 'Our AI studies and combines the professor\'s notes and books into a single solution. Upload your PDFs, the AI studies and simplifies them, then explain aloud and receive targeted feedback for top-grade performance.',
  'hero.description': 'Exclusive access to the most advanced technology for university students who want to be the first to revolutionize their study method and exam preparation.',
  'hero.requestAccess': 'Start Free',
  ...
  'hero.stat1': 'Study Time Reduced',
  'hero.stat2': 'Learning Speed',
  'hero.stat3': 'Exams Passed',
