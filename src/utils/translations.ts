...
export const englishTranslations: TranslationKeys = {
  ...
  'hero.subtitle': 'StudyAI is the only platform that increases learning speed and optimizes exam preparation time using the most advanced artificial intelligence.',
