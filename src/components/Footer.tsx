...
const Footer = () => {
  const footerLinks = {
    ...
    supporto: [
      ...
      { name: 'Guide e Tutorial', href: '#guides' },
      { name: 'FAQ', href: '#faq' },
            ...
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-slate-700 border border-slate-600 rounded-lg text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-oralmind-500"
                />
